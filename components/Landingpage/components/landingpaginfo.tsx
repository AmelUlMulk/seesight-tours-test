...
const LandingPageInfo = () => {
  ...
  return (
    ...
    >
      <h2 className="text-[#333333] text-[18px] sm:text-[26px] lg:text-[36px] font-[700] pb-3">
        WHY US
      </h2>
              ...
              {landingpPageInfo.map(
                (infoData: Record<string, string>, index: number) => {
                  return (
                    <div key={infoData.key} className="flex">
                      <div className="pt-2">
                        <h2 className="text-[26px] font-[500] text-[#9B9B9B]">
                          0{index + 1}
                        </h2>
                      </div>
                      <div className="md:pl-6 lg:pl-8 xl:pl-14">
                        <h2 className="text-[16px] sm:text-[22px] lg:text-[28px] font-[600] text-[#333333]">
                          {infoData.header}
                        </h2>
