...
const ContactHeader = () => {
  return (
    <section id="call-us" className="flex flex-col w-[85%] mx-auto py-10">
      <h2
        id="call-time"
        className="w-[90%] mx-auto text-[12px] sm:text-[24px] lg:text-[32px] font-[500] text-center text-[#333333]"
      >
        Call Us Anytime from: 8am - 4pm Monday-Friday
      </h2>
      <div className=" flex gap-5 text-white mt-5">
        <div className="flex-none w-[33.33%] bg-[#2191FA] rounded-[15px] py-3">
        ...
        <div className="flex-none w-[33.33%] bg-[#2191FA] rounded-[15px] py-3">
          <div className="flex flex-col gap-2 items-center">
            <Image src="/local.svg" width={55} height={55} alt="toll free" />
            <h2 className=" text-[18px] sm:text-[28px] lg:text-[36px] font-[600] ">
              Local
            </h2>
            <p className="text-[18px] sm:text-[20px] lg:text-[24px] font-[400]">
