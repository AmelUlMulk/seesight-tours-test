  ...
  return (
    <>
      ...
      <div className="px-36 py-10 text-justify">
        ...
        <h1 className="text-3xl leading-9 pt-5">
        ...
        <h1 className="text-3xl pt-4">INFORMATION COLLECTED BY “COOKIES”</h1>
        ...
        <h1 className="text-3xl pt-4">OPT OUT PROCESS</h1>
        <p className="text-lg ">
        ...
        <h1 className="text-3xl pt-4">ELECTRONIC NEWSLETTERS</h1>
        <p className="text-lg ">
