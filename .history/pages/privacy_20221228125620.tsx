  ...
  return (
    <>
      ...
      <div className="px-36 py-10">
        ...
        <ul className="list-decimal px-4 text-base">
          <li>
        ...
        <h1 className="text-3xl">INFORMATION COLLECTED BY “COOKIES”</h1>
        ...
        <h1 className="text-3xl">OPT OUT PROCESS</h1>
        <p className="text-lg ">
        ...
        <h1 className="text-3xl">ELECTRONIC NEWSLETTERS</h1>
        <p className="text-lg ">
