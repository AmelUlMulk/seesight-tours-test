  ...
  return (
    <>
      ...
      <div className="px-36 py-10 text-justify">
        <h1 className="text-3xl pt-4">INFORMATION COLLECTED</h1>
        <p className="text-lg ">
        ...
        <h1 className="text-3xl leading-9 pt-8">
        ...
        <h1 className="text-3xl pt-8">INFORMATION COLLECTED BY “COOKIES”</h1>
        ...
        <h1 className="text-3xl pt-8">OPT OUT PROCESS</h1>
        <p className="text-lg ">
          <ul className="list-disc px-4 text-lg break-normal">
        ...
        <h1 className="text-3xl pt-8">ELECTRONIC NEWSLETTERS</h1>
        <p className="text-lg ">
