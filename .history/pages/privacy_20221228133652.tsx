    ...
    <>
      <div className="relative">
        <Image
          ...
          alt="See sight Tours"
        />
        <div className="absolute top-6 pt-20 pl-32">
      ...
      <div className="px-36 py-10 text-justify">
        <h1 className="text-3xl pt-4 font-normal">INFORMATION COLLECTED</h1>
        <p className="text-lg ">
        ...
        <h1 className="text-3xl leading-9 pt-8 font-normal">
        ...
        <h1 className="text-3xl pt-4 font-normal">
        ...
        <h1 className="text-3xl pt-8 font-normal">
        ...
        <h1 className="text-3xl pt-8 font-normal">OPT OUT PROCESS</h1>
        <p className="text-lg ">
          ...
          out will no longer customize ads based on your interests and web usage
          patterns using cookie-based technology. You may, at any time, view and
          update any of your personal information, or tell us to stop using or
          retaining it. You can do so by clicking on the appropriate buttons
          that appear on any e-communications we send to you or by emailing your
          request to info@seesight-tours.com. If you tell us to stop using your
        ...
        <h1 className="text-3xl pt-8 font-normal">ELECTRONIC NEWSLETTERS</h1>
        <p className="text-lg ">
