...
const Privacy = () => {
  return (
    <div className="bg-[url(https://res.cloudinary.com/see-sight-tours/image/upload/w_1920,h_500/t_header/f_auto,q_auto,/fl_progressive:steep/v1581438789/top-ottawa-Parliament-Buildings.webP)] h-96 w-full bg-cover bg-center p-24 mix-blend-overlay">
      {/* <Image 
